	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("芜湖", "将删除与员工相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							$.messager.alert("芜湖","请检查你输入的数据嗷!","warning");
							return;
						} else{
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("芜湖","添加失败!","warning");
										return;
									}
								}
							});
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("芜湖","更新失败!","warning");
										return;
									}
								}
							});
