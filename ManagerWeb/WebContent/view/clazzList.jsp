	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("芜湖", "将删除部门信息（如果部门下存在员工或部长则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	  ...
	  //修改按钮监听事件
	  	$("#edit-btn").click(function(){
	    	...
	    	//console.log(selectRow);
        	if(selectRow == null){
            	$.messager.alert("芜湖", "请选择数据进行修改!", "warning");
            	return;
            }
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$.messager.alert("芜湖","修改失败!","warning");
										return;
									}
								}
							});
