		...
		$("#submitBtn").click(function(){
			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
						$.messager.alert("芜湖", "验证码错啦", "warning");
						$("#vcodeImg").click();//切换验证码
						$("input[name='vcode']").val("");//清空验证码输入框
					} else if("loginError" == msg){
						$.messager.alert("芜湖", "用户名或密码错啦", "warning");
						$("#vcodeImg").click();//切换验证码
						$("input[name='vcode']").val("");//清空验证码输入框
...
<<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">人力资源管理系统</h2>
</div>body>
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          <input class="input-text size-L" name="vcode" type="text" placeholder="快输入验证码" style="width: 200px;">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
		...
		<div class="radio-box">
			...
			<label for="radio-2">部长</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="radio-1" name="type" value="1" />
			<label for="radio-3">老板</label>
		</div>
	</div>
...
<div class="footer">1805030324 &nbsp; 董笑天 苏榆 宋昊 </div>
