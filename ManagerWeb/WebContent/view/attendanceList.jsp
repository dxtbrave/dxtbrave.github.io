	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
 		       ...
 		       {field:'type',title:'类型',width:200, sortable: false},
 		      {field:'date',title:'日期',width:200, sortable: false}
	 		]], 
	        toolbar: "#toolbar",
	  ...
	  //设置编辑按钮
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	var id = selectRow.id;
            	$.messager.confirm("芜湖", "将删除相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	  ...
	  //下拉框通用属性
	    ...
	    $("#add_studentList").combobox({
	  	...
	  	var typeData = [{id:"奖金",text:"奖金"},{id:"工资",text:"工资"},{id:"惩罚",text:"惩罚"}];
